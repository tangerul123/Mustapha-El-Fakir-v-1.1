...
- **Multi-language support** with a custom JavaScript-based language switcher  
- Built with **SCSS** for cleaner, modular, and maintainable styling  
- Organized and production-ready folder structure  
...
- **Bootstrap 5**  
- **Vanilla JavaScript (for interactivity & language system)**  
